...
"d_0": { x: 1*width/10, y: 5*height/10, color: "#FFFFCC", cnt: 0, fullname: "HOUR-0" },
"d_1": { x: 2*width/10, y: 5*height/10, color: "#FFEDA0", cnt: 0, fullname: "HOUR-1" },
"d_2": { x: 3*width/10, y: 5*height/10, color: "#FED976", cnt: 0, fullname: "HOUR-2" },
"d_3": { x: 4*width/10, y: 5*height/10, color: "#FEB24C", cnt: 0, fullname: "HOUR-3" },
"d_4": { x: 5*width/10, y: 5*height/10, color: "#FD8D3C", cnt: 0, fullname: "HOUR-4" },
"d_5": { x: 6*width/10, y: 5*height/10, color: "#FC4E2A", cnt: 0, fullname: "HOUR-5" },
"d_6": { x: 7*width/10, y: 5*height/10, color: "#E31A1C", cnt: 0, fullname: "HOUR-6" },
  ...
  main.variable(observer("chart")).define("chart", ["d3","width","height","nodes","groups","forceCluster","forceCollide"], function(d3,width,height,nodes,groups,forceCluster,forceCollide)
{
  ...
  svg.selectAll('.grpcnt')
    ...
    .attr("text-anchor", "middle")
    .attr("x", d => groups[d].x)
    .attr("y", d => groups[d].y - 100) // 구슬과 cnt 위치 차이
    .text(d => groups[d].cnt);
